...
<div class="wrapper">
  {#each countDotsArr as countDots}
    <Dot color={$store.colors.color1} />
    <Dot color={$store.colors.color2} />
    <Dot color={$store.colors.color3} />
    <Dot color={$store.colors.color4} />
  {/each}
</div>
